...
__o = __obj[700]  // ti.sysbios.knl.Task.Instance#0/instance
    ...
    __o['name'] = String(java.net.URLDecoder.decode('keyboard_task', 'UTF-8'))
...
__o = __obj[704]  // ti.sysbios.knl.Task.Instance#2/instance
    ...
    __o['name'] = String(java.net.URLDecoder.decode('cellular_task', 'UTF-8'))
...
__o = __obj[956]  
    ...
    __o['cfgScript'] = String(java.net.URLDecoder.decode('C%3A%2FUsers%2Fbeat%2FDocuments%2Foctanis%2FOctanis4-Firmware%2FOctoPhone%2Fempty.cfg', 'UTF-8'))
    __o['prelink'] = false
